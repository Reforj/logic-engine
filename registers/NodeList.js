...
export default [
  {
    ...
    children: [
      ...
      {key: 'Logic.And', title: '&& (And)', type: "Operator", nodeTitle: 'AND', path: 'Logic.And', pure: true,
        inputs: [{dataType: 'boolean', defaultValue: false}, {dataType: 'boolean', defaultValue: false}],
        outputs: [{dataType: 'boolean'}],
        canAddInputs: true
      },
      {key: 'Logic.Or', title: '|| (Or)', type: "Operator", nodeTitle: 'OR', path: 'Logic.Or', pure: true,
        inputs: [{dataType: 'boolean', defaultValue: false}, {dataType: 'boolean', defaultValue: false}],
        outputs: [{dataType: 'boolean'}],
        canAddInputs: true
      },
      {key: 'Logic.Equal', title: '=== (Equal)', type: "Operator", nodeTitle: 'EQUAL', path: 'Logic.Equal', pure: true,
        inputs: [{dataType: 'any', defaultValue: false}, {dataType: 'any', defaultValue: false}],
        outputs: [{dataType: 'boolean'}],
      },
      {key: 'Logic.NotEqual', title: '!== (NotEqual)', type: "Operator", nodeTitle: 'NOT EQUAL', path: 'Logic.NotEqual', pure: true,
        inputs: [{dataType: 'any', defaultValue: false}, {dataType: 'any', defaultValue: false}],
        outputs: [{dataType: 'boolean'}],
      },
